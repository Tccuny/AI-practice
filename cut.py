# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 16:59:19 2019
...
def split_licensePlate_character(plate_binary_img):
    ...
    for i in range(len(split_list)):
        ...
        cv2.imwrite("chars/"+str(i)+".jpg", single_character_Arr)
    cv2.waitKey(0)
...
if __name__ == '__main__':
   split_licensePlate_character(remove_plate_upanddown_border('tmp/middle_res.png'))